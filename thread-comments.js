$(function() {
  var url = window.location.href,
    ...
    id = '',
    li = '',
    m = 5, // عدد التعليقات المعروضة على الشاشة الرئيسية
    n = str.length,
    k = 0,
    p = 0
	$("#top-continue").removeClass("hidden");
  // استدعاء iframe عند النقر على زر الرد
  ...
  // اتصل بـ iframe عند النقر فوق الزر "إضافة تعليق" السفلي
  ...
  // يعالج عنوان المتصفح إذا كان هناك رابط للتعليق
